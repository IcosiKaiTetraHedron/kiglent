"""Extensible attributed text format for representing kiglent formatted documents."""
...
class AttributedTextDecoder(kiglent.text.DocumentDecoder):  # noqa: D101

    def __init__(self) -> None:  # noqa: D107
        self.doc = kiglent.text.document.FormattedDocument()
        self.length = 0
        self.attributes = {}

    def decode(self, text: str, location: Location | None = None) -> kiglent.text.document.FormattedDocument:  # noqa: ARG002
