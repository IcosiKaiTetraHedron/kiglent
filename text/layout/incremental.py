...
from kiglent.font.base import grapheme_break, GlyphPosition
from kiglent.text import runlist
from kiglent.text.layout.base import (
    TextLayout,
    _AbstractBox,
    _InlineElementBox,
    _InvalidRange,
...
from kiglent.text.layout.scrolling import ScrollableTextDecorationGroup, ScrollableTextLayoutGroup

if TYPE_CHECKING:
    from kiglent.customtypes import AnchorX, AnchorY, Color4
...
class IncrementalTextLayout(TextLayout, EventDispatcher):
    ...
    Unlike :py:func:`~kiglent.text.layout.TextLayout` and
    :py:class:`~kiglent.text.layout.ScrollableTextLayout`, this class generates
    ...
    affected line(s) are reflowed.  Use :py:meth:`~kiglent.text.layout.TextLayout.begin_update` and
    :py:meth:`~kiglent.text.layout.TextLayout.end_update` to
    further reduce the amount of processing required.

    The layout can also display a text selection (text with a different
    background color).  The :py:class:`~kiglent.text.caret.Caret` class implements
    ...
    _selection_color: Color4 = (255, 255, 255, 255)
    _selection_background_color: Color4 = (46, 106, 197, 255)
    ...
    def selection_start(self) -> int:
        ...
        :see: py:meth:`~kiglent.text.layout.IncrementalTextLayout.set_selection`
        """
    ...
    @property
    def selection_color(self) -> Color4:
    ...
    def selection_color(self, color: Color4) -> None:
        self._selection_color = color
        self._invalid_style.invalidate(self._selection_start, self._selection_end)

    @property
    def selection_background_color(self) -> Color4:
    ...
    def selection_background_color(self, background_color: Color4) -> None:
