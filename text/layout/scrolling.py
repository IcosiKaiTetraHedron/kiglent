...
from kiglent.text.layout.base import TextLayout

if TYPE_CHECKING:
    from kiglent.customtypes import AnchorX, AnchorY
...
class ScrollableTextLayoutGroup(graphics.Group):
    """Default rendering group for :py:class:`~kiglent.text.layout.ScrollableTextLayout`.
...
class ScrollableTextLayout(TextLayout):
    ...
    clips the text that would be drawn in :py:func:`~kiglent.text.layout.TextLayout`
