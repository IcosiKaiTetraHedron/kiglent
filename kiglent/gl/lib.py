...
_debug_gl = kiglent.options['debug_gl']
_debug_gl_trace = kiglent.options['debug_gl_trace']
_debug_gl_trace_args = kiglent.options['debug_gl_trace_args']
...
if kiglent.compat_platform in ('win32', 'cygwin'):
    from kiglent.gl.lib_wgl import link_GL, link_WGL
elif kiglent.compat_platform == 'darwin':
    from kiglent.gl.lib_agl import link_AGL, link_GL
else:
    from kiglent.gl.lib_glx import link_GL, link_GLX
