...
from kiglent.gl import glx
from kiglent.gl import glxext_arb
from kiglent.gl import glx_info
from kiglent.gl import glxext_mesa
from kiglent.gl import lib
from kiglent.gl.base import Config, DisplayConfig, Context

from kiglent.display.xlib import XlibCanvas
from kiglent.libs.x11 import xlib
from kiglent.libs.x11.xrender import XRenderFindVisualFormat

if TYPE_CHECKING:
    from kiglent.libs.x11.xlib import Display
...
class XlibDisplayConfig(DisplayConfig):  # noqa: D101
    ...
    attribute_ids = {  # noqa: RUF012
        ...
        # Not supported in current kiglent API:
