...
from kiglent.gl import GL_TRIANGLES
        ...
        for node in self.nodes:
            for mesh in node.meshes:
                ...
                if material.texture_name:
                    program = kiglent.model.get_default_textured_shader()
                    texture = kiglent.resource.texture(material.texture_name)
                    matgroup = TexturedMaterialGroup(material, program, texture, parent=group)
                else:
                    program = kiglent.model.get_default_shader()
