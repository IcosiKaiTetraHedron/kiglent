...
Example usage::
    ...
    from kiglent import window
    from kiglent.text import layout, caret
...
from kiglent import clock, event
...
if TYPE_CHECKING:
    ...
    from kiglent.text.layout import IncrementalTextLayout

class Caret(EventDispatcher):
    """Visible text insertion marker for `kiglent.text.layout.IncrementalTextLayout`.
    ...
    appropriate widget.  Kiglent does not provide such a toolkit at this stage.
    """
    ...
    def __init__(self, layout: IncrementalTextLayout, batch: Batch | None = None,
        ...
        :Parameters:
            `layout` : `~kiglent.text.layout.IncrementalTextLayout`
                Layout to control.
    ...
    def layout(self, layout: IncrementalTextLayout) -> None:
        ...
        from kiglent.gl import GL_LINES
        self._layout = layout
    ...
    def get_style(self, attribute: str) -> Any:
        ...
        Args:
            attribute:
                ...
                :py:mod:`~kiglent.text.document` for a list of recognised attribute
                names.
        """
    ...
    def on_text(self, text: str) -> bool:
        """Handler for the `kiglent.window.Window.on_text` event.
    ...
    def on_text_motion(self, motion: int, select: bool = False) -> bool:
        """Handler for the `kiglent.window.Window.on_text_motion` event.
    ...
    def on_text_motion_select(self, motion: int) -> bool:
        """Handler for the `kiglent.window.Window.on_text_motion_select` event.
    ...
    def on_mouse_scroll(self, x: float, y: float, scroll_x: float, scroll_y: float) -> bool:  # noqa: ARG002
        """Handler for the `kiglent.window.Window.on_mouse_scroll` event.
    ...
    def on_mouse_press(self, x: int, y: int, button: int, modifiers: int) -> bool:  # noqa: ARG002
        """Handler for the `kiglent.window.Window.on_mouse_press` event.
    ...
    def on_mouse_drag(self, x: int, y: int, dx: int, dy: int, buttons: int, modifiers: int) -> bool:  # noqa: ARG002
        """Handler for the `kiglent.window.Window.on_mouse_drag` event.
    ...
    def on_activate(self) -> bool:
        """Handler for the `kiglent.window.Window.on_activate` event.
    ...
    def on_deactivate(self) -> bool:
        """Handler for the `kiglent.window.Window.on_deactivate` event.
