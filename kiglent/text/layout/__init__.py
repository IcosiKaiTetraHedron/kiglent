...
:py:class:`~kiglent.text.layout.TextLayout`
...
:py:class:`~kiglent.text.layout.ScrollableTextLayout`
    Based on :py:func:`~kiglent.text.layout.TextLayout`.
...
:py:class:`~kiglent.text.layout.IncrementalTextLayout`
    Based on :py:class:`~kiglent.text.layout.ScrollableTextLayout`.
...
All three layout classes can be used with either :py:class:`~kiglent.text.document.UnformattedDocument` or
:py:class:`~kiglent.text.document.FormattedDocument`, and can be either single-line or ``multiline``.  The
...
from kiglent.text.layout.incremental import (
    IncrementalTextDecorationGroup,
    IncrementalTextLayout,
    IncrementalTextLayoutGroup,
)
from kiglent.text.layout.scrolling import ScrollableTextDecorationGroup, ScrollableTextLayout, ScrollableTextLayoutGroup
