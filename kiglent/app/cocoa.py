...
from kiglent.app.base import PlatformEventLoop, EventLoop
from kiglent.libs.darwin import cocoapy, AutoReleasePool, ObjCSubclass, PyObjectEncoding, ObjCInstance, send_super, \
...
class _AppDelegate_Implementation:
    ...
    def init(self, kiglent_loop):
        objc = ObjCInstance(send_super(self, 'init'))
        self._kiglent_loop = kiglent_loop
        return objc  # objc is self

    @_AppDelegate.method('v')
    def updateKiglent_(self):
        self._kiglent_loop.nsapp_step()

    @_AppDelegate.method('v@')
    def applicationWillTerminate_(self, notification):
        self._kiglent_loop.is_running = False
        self._kiglent_loop.has_exit = True

    @_AppDelegate.method('v@')
    def applicationDidFinishLaunching_(self, notification):
        self._kiglent_loop._finished_launching = True
...
class CocoaPlatformEventLoop(PlatformEventLoop):
    ...
    def nsapp_start(self, interval):
        ...
        from kiglent.app import event_loop
