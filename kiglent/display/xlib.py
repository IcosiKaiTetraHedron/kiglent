...
try:
    from kiglent.libs.x11 import xinerama
...
try:
    from kiglent.libs.x11 import xf86vmode
...
try:
    from kiglent.libs.x11 import xrandr
    ...
    def set_mode(self, mode: XlibScreenModeXrandr) -> None:
        ...
        if res_ptr:
            ...
            if crtc_info_ptr:
                ...
                if status != 0 and kiglent.options['debug_x11']:
