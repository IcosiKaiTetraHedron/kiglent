...
from kiglent.image.codecs.gdiplus import BitmapData, ImageLockModeRead, PixelFormat32bppARGB, Rect, gdiplus
from kiglent.libs.win32 import _gdi32 as gdi32
from kiglent.libs.win32 import _user32 as user32
from kiglent.libs.win32.constants import ANTIALIASED_QUALITY, FW_BOLD, FW_NORMAL
from kiglent.libs.win32.context_managers import device_context
from kiglent.libs.win32.types import ABC, BYTE, LOGFONTW, TEXTMETRIC

if TYPE_CHECKING:
    from kiglent.font.base import Glyph
...
class GDIPlusGlyphRenderer(base.GlyphRenderer):
    ...
    def _create_bitmap(self, width: int, height: int) -> None:
        ...
        gdiplus.GdipSetTextRenderingHint(self._graphics,
            _text_quality[kiglent.options.text_antialiasing])
