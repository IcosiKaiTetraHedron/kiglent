...
import kiglent.image
from kiglent.font import base
from kiglent.font.base import Glyph, GlyphPosition
from kiglent.libs.darwin import CGFloat, cocoapy, kCTFontURLAttribute, cfnumber_to_number, \
    kCTFontWeightTrait
from kiglent.font.harfbuzz import harfbuzz_available, get_resource_from_ct_font, \
...
if harfbuzz_available():
    ...
    """
    from kiglent.font.harfbuzz.harfbuzz_lib import hb_lib, hb_destroy_func_t, hb_reference_table_func_t, HB_MEMORY_MODE_READONLY
...
class QuartzGlyphRenderer(base.GlyphRenderer):
    ...
    def render_index(self, glyph_index: int):
        ...
        quartz.CGContextSetShouldAntialias(bitmap_context, kiglent.options.text_antialiasing)
        ...
        if buffer_ptr:
            ...
            glyph_image = kiglent.image.ImageData(width, height, "RGBA", buffer, bytes_per_row)
