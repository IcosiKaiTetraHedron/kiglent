...
kiglent can play WAV files, and if FFmpeg is installed, many other audio and
video formats.
...
Kiglent relies on Python's garbage collector to release resources when a player
...
def load(filename: str, file: BinaryIO | None = None,
    ...
    Args:
        ...
        streaming:
            ...
            (default) a :class:`~kiglent.media.StreamingSource` is created.
        decoder:
