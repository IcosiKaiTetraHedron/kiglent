...
from kiglent.media.devices import get_audio_device_manager
from kiglent.media.devices.base import DeviceFlow
from kiglent.media.exceptions import MediaException
...
class _VoiceResetter:
    ...
    def run(self):
        if self.voice.buffers_queued != 0:
            ...
            kiglent.clock.schedule_once(self._finish, 0)
    ...
    def destroy(self):
        kiglent.clock.unschedule(self._finish)
        self.driver = None
        self.voice = None
        self.remaining_data.clear()
...
class XAudio2Driver:
    ...
    def __init__(self):
        ...
        if self.restart_on_error:
            ...
            if audio_devices:
                ...
                kiglent.clock.schedule_interval_soft(self._check_state, 0.5)
    ...
    def _delete_driver(self):
        if self._xaudio2:
            ...
            # Stop 3d
            if self.allow_3d:
                kiglent.clock.unschedule(self._calculate_3d_sources)
    ...
    def enable_3d(self):
        ...
        kiglent.clock.schedule_interval_soft(self._calculate_3d_sources, 1 / 15.0)
    ...
    def delete(self):
        self._delete_driver()
        kiglent.clock.unschedule(self._check_state)
