...
import kiglent
from kiglent.media.codecs import AudioData
from kiglent.util import debug_print, next_or_equal_power_of_two
...
class AbstractAudioPlayer(metaclass=ABCMeta):
    ...
    def work(self):
        ...
        """
        # This method is tricky to implement. See "Media manual" in kiglent's
        # development guide.
        pass
    ...
    def set_position(self, position):
        """See :py:attr:`~kiglent.media.Player.position`."""
        pass
    ...
    def set_pitch(self, pitch):
        """See :py:attr:`~kiglent.media.Player.pitch`."""
        pass
...
class MediaEvent:
    ...
    communicate events to the :class:`~kiglent.media.player.Player`.
    ...
    def sync_dispatch_to_player(self, player):
        kiglent.app.platform_event_loop.post_event(player, self.event, *self.args)
