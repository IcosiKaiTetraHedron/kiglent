...
class KiglentDelegate_Implementation:
    KiglentDelegate = ObjCSubclass('NSObject', 'KiglentDelegate')

    @KiglentDelegate.method(b'@' + PyObjectEncoding)
    def initWithWindow_(self, window: CocoaWindow) -> ObjCInstance | None:
        ...
        # can dispatch the corresponding kiglent events.
        ...
        if not self._window._shadow:
            ...
            if old_scale != new_scale:
                ...
                if kiglent.options.dpi_scaling == "real":
                    ...
                    if kiglent.options.dpi_scaling == "scaled":
...
KiglentDelegate = ObjCClass('KiglentDelegate')
