...
from kiglent.image import *
from kiglent.image.codecs import *
from kiglent.image.codecs import gif

import kiglent.lib
import kiglent.window

gdk = kiglent.lib.load_library('gdk-x11-2.0')
gdkpixbuf = kiglent.lib.load_library('gdk_pixbuf-2.0')
