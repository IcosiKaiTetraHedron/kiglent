...
from kiglent.input.base import AbsoluteAxis, Button, Controller, ControllerManager, Device
from kiglent.libs.win32 import _ole32 as ole32
from kiglent.libs.win32 import _oleaut32 as oleaut32
from kiglent.libs.win32 import com
from kiglent.libs.win32.constants import CLSCTX_INPROC_SERVER
from kiglent.libs.win32.types import BYTE, VARIANT
...
class XInputDeviceManager(EventDispatcher):
        ...
        while not self._exit.is_set():
            ...
            if elapsed >= detect_rate:
                ...
                for i in xuser_max_count - self._connected_devices:
                    ...
                    kiglent.app.platform_event_loop.post_event(self, 'on_connect', device)
            ...
            for i in self._connected_devices.copy():
                ...
                if result == ERROR_DEVICE_NOT_CONNECTED:
                    ...
                    if device.connected:
                        ...
                        # Dispatch event in main thread:
                        kiglent.app.platform_event_loop.post_event(self, 'on_disconnect', device)
                        continue
                    ...
                    kiglent.app.platform_event_loop.post_event(self, '_on_state_change', device)
    ...
    def _on_state_change(device):
        ...
        for button, name in controller_api_to_kiglent.items():
...
class XInputController(Controller):
    ...
    def _initialize_controls(self):
        ...
        for button_name in controller_api_to_kiglent.values():
