import ctypes
import kiglent
from kiglent.input.base import Device, DeviceOpenException
from kiglent.input.base import Button, RelativeAxis, AbsoluteAxis
from kiglent.libs.x11 import xlib
from kiglent.util import asstr

try:
    from kiglent.libs.x11 import xinput as xi
...
class XInputWindowEventDispatcher:
    ...
    @kiglent.window.xlib.XlibEventHandler(0)
    ...
    @kiglent.window.xlib.XlibEventHandler(-1)
