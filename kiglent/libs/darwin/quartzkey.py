...
For clarity, a few constants use custom kiglent-specific names.
These include:
================ ======================
New kiglent name  Name in referenced .h
================ ======================
...
SDL 1.X's SDL_Quartzkeys.h. Although some names are kiglent-specific,
