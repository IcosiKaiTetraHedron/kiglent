...
_lib = kiglent.lib.load_library('Xi')
...
Display = kiglent.libs.x11.xlib.Display
Window = kiglent.libs.x11.xlib.Window
XID = kiglent.libs.x11.xlib.XID
Time = kiglent.libs.x11.xlib.Time
...
KeySym = kiglent.libs.x11.xlib.KeySym
...
Atom = kiglent.libs.x11.xlib.Atom
struct__XDeviceInfo._fields_ = [
    ('id', XID),
    ('type', Atom),
    ('name', c_char_p),
...
KeyCode = kiglent.libs.x11.xlib.KeyCode
...
XModifierKeymap = kiglent.libs.x11.xlib.XModifierKeymap
...
XEvent = kiglent.libs.x11.xlib.XEvent
