...
if TYPE_CHECKING:
    from kiglent.window.cocoa import CocoaWindow
...
class KiglentTextView_Implementation:
    KiglentTextView = ObjCSubclass('NSTextView', 'KiglentTextView')

    @KiglentTextView.method(b'@' + PyObjectEncoding)
...
KiglentTextView = ObjCClass('KiglentTextView')
