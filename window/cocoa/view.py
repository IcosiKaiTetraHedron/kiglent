...
import kiglent
from kiglent.libs.darwin import (
    NSAlphaShiftKeyMask,
    NSFunctionKeyMask,
...
from kiglent.libs.darwin.quartzkey import charmap, keymap
from kiglent.window import key, mouse

from .kiglent_textview import KiglentTextView
...
def getMousePosition(self: KiglentView_Implementation | cocoapy.ObjCInstance, nsevent: cocoapy.ObjCInstance) \
        -> tuple[int, int]:
...
class KiglentView_Implementation:
    KiglentView = cocoapy.ObjCSubclass('NSView', 'KiglentView')

    @KiglentView.method(b'@' + cocoapy.NSRectEncoding + cocoapy.PyObjectEncoding)
    def initWithFrame_cocoaWindow_(self, frame: cocoapy.NSRect, window: CocoaWindow) -> cocoapy.ObjCInstance | None:
        ...
        # Create an instance of KiglentTextView to handle text events.
    ...
    @KiglentView.method(b'v' + cocoapy.NSSizeEncoding)
...
KiglentView = cocoapy.ObjCClass('KiglentView')
