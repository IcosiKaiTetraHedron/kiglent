...
from kiglent.gl import gl_info, wgl, wgl_info, wglext_arb
from kiglent.libs.win32 import PIXELFORMATDESCRIPTOR, _gdi32
...
class Win32Config(Config):  # noqa: D101
    ...
    def _get_pixel_format_descriptor_matching_configs(self, canvas: Win32Canvas) -> list[Win32DisplayConfig]:
        ...
        #  Not supported in kiglent API: swap_copy: PFD_SWAP_COPY and swap_exchange: PFD_SWAP_EXCHANGE
