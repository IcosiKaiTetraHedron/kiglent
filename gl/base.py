...
if TYPE_CHECKING:
    ...
    from kiglent.display.base import Canvas
    from kiglent.gl.gl_info import GLInfo
...
class Config:
    ...
    def is_complete(self) -> bool:
        ...
        For example, `kiglent.window.Screen.get_matching_configs` returns
        complete configs.
...
class Context:
    ...
    def create_program(self, *sources: tuple[str, str]) -> ShaderProgram:
        ...
        :py:class:`~kiglent.graphics.shader.ShaderProgram` instance.
        ...
        :py:class:`~kiglent.graphics.shader.Shader` for more information.
        ...
        shaders = (kiglent.graphics.shader.Shader(src, srctype) for (src, srctype) in sources)
        program = kiglent.graphics.shader.ShaderProgram(*shaders)
