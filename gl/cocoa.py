...
from kiglent.gl import ContextException
from kiglent.gl.base import DisplayConfig, Config, Context
from kiglent.libs.darwin import cocoapy, quartz
...
_gl_attributes = {
    ...
    # Not exposed by kiglent API (set internally)
...
class CocoaDisplayConfig(DisplayConfig):  # noqa: D101
    ...
    def __init__(self, canvas: CocoaCanvas, config: CocoaConfig, pixel_format: NSOpenGLPixelFormat) -> None:  # noqa: D107
        ...
        # Set these attributes so that we can run kiglent.info.
