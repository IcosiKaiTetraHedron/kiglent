...
from kiglent.gl.gl import GL_EXTENSIONS, glGetString
from kiglent.gl.lib import MissingFunctionException
from kiglent.gl.wglext_arb import wglGetExtensionsStringEXT
