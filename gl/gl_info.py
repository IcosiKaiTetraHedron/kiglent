...
from kiglent.gl.gl import GL_EXTENSIONS, GL_MAJOR_VERSION, GL_MINOR_VERSION, GL_RENDERER, GL_VENDOR, GL_VERSION, GLint
from kiglent.gl.lib import GLException
from kiglent.util import asstr


def _get_number(parameter: int) -> int:
    from kiglent.gl.gl import glGetIntegerv
    number = GLint()
...
class GLInfo:
    ...
    def set_active_context(self) -> None:
        ...
        if not self._have_info:
            ...
            from kiglent.gl.gl import GL_NUM_EXTENSIONS, glGetString, glGetStringi
