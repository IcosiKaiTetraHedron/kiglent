...
from kiglent.app.xlib import XlibSelectDevice
from kiglent.libs.ioctl import _IOR, _IOR_str, _IOR_len, _IOW
from kiglent.input.base import Device, RelativeAxis, AbsoluteAxis, Button, Joystick, Controller
from kiglent.input.base import DeviceOpenException, ControllerManager
from kiglent.input.controller import get_mapping, Relation, create_guid

try:
    from os import readv as _readv
except ImportError:
    # Workaround for missing os.readv in PyPy
    c = kiglent.lib.load_library('c')
...
class EvdevDevice(XlibSelectDevice, Device):
    ...
    def open(self, window=None, exclusive=False):
        ...
        kiglent.app.platform_event_loop.select_devices.add(self)
    ...
    def close(self):
        ...
        kiglent.app.platform_event_loop.select_devices.remove(self)
