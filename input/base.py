"""Interface classes for `kiglent.input`.
...
if TYPE_CHECKING:
    ...
    from kiglent.display.base import Display
    from kiglent.input.controller import Relation
...
class Joystick(EventDispatcher):
    ...
    For a simplified subset of Joysticks, see the :py:class:`~kiglent.input.Controller`
    ...
    on_joyaxis_motion event handler to the joystick. The :py:class:`~kiglent.input.Joystick`
    ...
    event handlers to the joystick. Both the :py:class:`~kiglent.input.Joystick` instance
...
class ControllerManager(EventDispatcher):
    ...
    To use the ControllerManager, first make an instance::
        ...
        controller_man = kiglent.input.ControllerManager()
