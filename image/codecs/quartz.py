...
from kiglent.image import ImageData, Animation, AnimationFrame
from kiglent.image.codecs import *

from kiglent.libs.darwin.cocoapy import cf, quartz, NSMakeRect
from kiglent.libs.darwin.cocoapy import cfnumber_to_number
from kiglent.libs.darwin.cocoapy import kCGImageAlphaPremultipliedLast
from kiglent.libs.darwin.cocoapy import kCGImagePropertyGIFDictionary
from kiglent.libs.darwin.cocoapy import kCGImagePropertyGIFDelayTime
...
class QuartzImageDecoder(ImageDecoder):
    ...
    def _get_kiglent_ImageData_from_source_at_index(self, sourceRef, index):
    ...
    def decode(self, filename, file):
        ...
        image = self._get_kiglent_ImageData_from_source_at_index(sourceRef, 0)
    ...
    def decode_animation(self, filename, file):
        ...
        for index in range(count):
            ...
            cf.CFRelease(props)
            image = self._get_kiglent_ImageData_from_source_at_index(sourceRef, index)
