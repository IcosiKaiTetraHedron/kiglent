...
Rendering is performed on the content area of a :class:`kiglent.window.Window`,
or an entire screen.
...
if _is_kiglent_doc_run:
    from kiglent.display.base import Display, Screen, Canvas, ScreenMode
else:
    from kiglent import compat_platform, options
    if options['headless']:
        from kiglent.display.headless import HeadlessDisplay as Display
        from kiglent.display.headless import HeadlessScreen as Screen
        from kiglent.display.headless import HeadlessCanvas as Canvas
    elif compat_platform == 'darwin':
        from kiglent.display.cocoa import CocoaDisplay as Display
        from kiglent.display.cocoa import CocoaScreen as Screen
        from kiglent.display.cocoa import CocoaCanvas as Canvas
    elif compat_platform in ('win32', 'cygwin'):
        from kiglent.display.win32 import Win32Display as Display
        from kiglent.display.win32 import Win32Screen as Screen
        from kiglent.display.win32 import Win32Canvas as Canvas
    elif compat_platform == 'linux':
        from kiglent.display.xlib import XlibDisplay as Display
        from kiglent.display.xlib import XlibScreen as Screen
        from kiglent.display.xlib import XlibCanvas as Canvas
    else:
