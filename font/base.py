"""Abstract classes used by kiglent.font implementations.

These classes should not be constructed directly.  Instead, use the functions
in `kiglent.font` to obtain platform-specific instances.  You can use these
...
from kiglent.gl import GL_LINEAR, GL_RGBA, GL_TEXTURE_2D
...
class Glyph(image.TextureRegion):
    ...
    #: :If a glyph is colored by the font renderer, such as an emoji, it may be treated differently by kiglent.
    colored = False
...
class GlyphRenderer(abc.ABC):
    ...
    def __init__(self, font: Font) -> None:
        ...
        Args:
            font: The :py:class:`~kiglent.font.base.Font` object to be rendered.
        """
        self.font = font
...
class Font:
    ...
    To construct a font, use :py:func:`kiglent.font.load`, which will instantiate the
    ...
    def __init__(self) -> None:
        """Initialize a font that can be used with Kiglent."""
    ...
    def add_font_data(cls: type[Font], data: BinaryIO) -> None:
        ...
        must use :py:func:`kiglent.font.load` specifying the font name.
        """
