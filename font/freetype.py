...
from kiglent.font.fontconfig import get_fontconfig
from kiglent.font.freetype_lib import (
    FT_LOAD_RENDER,
    FT_PIXEL_MODE_GRAY,
    FT_PIXEL_MODE_MONO,
    FT_STYLE_FLAG_BOLD,
...
from kiglent.font.harfbuzz import harfbuzz_available, get_resource_from_ft_font, get_harfbuzz_shaped_glyphs
from kiglent.util import asbytes, asstr
...
class FreeTypeGlyphRenderer(base.GlyphRenderer):
    ...
    def _create_glyph(self) -> base.Glyph:
        ...
        # In FT positive pitch means `down` flow, in Kiglent ImageData
...
class FreeTypeFace:
    ...
    def get_glyph_slot(self, glyph_index: int) -> FT_GlyphSlot:
        ...
        if kiglent.options.text_antialiasing is False:
