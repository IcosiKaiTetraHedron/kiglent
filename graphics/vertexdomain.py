...
from kiglent.graphics import allocation, shader, vertexarray
from kiglent.graphics.vertexbuffer import AttributeBufferObject, IndexedBufferObject

CTypesDataType = Type[_SimpleCData]
CTypesPointer = _Pointer

if TYPE_CHECKING:
    from kiglent.graphics.allocation import Allocator
    from kiglent.graphics.shader import Attribute
    from kiglent.graphics.vertexarray import VertexArray
