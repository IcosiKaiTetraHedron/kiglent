...
The :py:mod:`~kiglent.clock` module allows you to schedule functions
to run periodically, or for one-shot future execution. kiglent's default
event loop (:py:func:`~kiglent.app.run`) keeps an internal instance of
a :py:class:`~kiglent.clock.Clock`, which is ticked automatically.
...
:py:class:`~kiglent.clock.Clock` which is initialised with the module.  You can
get this instance to use directly::

    clk = kiglent.clock.get_default()

You can also replace the default clock with your own:

    myclk = kiglent.clock.Clock()
    kiglent.clock.set_default(myclk)
...
class Clock:
    ...
    def call_scheduled_functions(self, dt: float) -> bool:
        ...
        (see :py:meth:`~kiglent.clock.tick`), so you need not call it
    ...
    def schedule(self, func: Callable, *args: Any, **kwargs: Any) -> None:
        ...
        .. note:: Functions scheduled using this method will be called
                  every tick by the default kiglent event loop, which can
                  lead to high CPU usage. It is usually better to use
                  :py:meth:`~kiglent.clock.schedule_interval` unless
                  this is desired.
        """
    ...
    def schedule_once(self, func: Callable, delay: float, *args: Any, **kwargs: Any) -> None:
        ...
        :py:meth:`~kiglent.clock.Clock.schedule`.
        """
    ...
    def schedule_interval(self, func: Callable, interval: float, *args: Any, **kwargs: Any) -> None:
        ...
        for the interval, and so on. If kiglent is unable to call the function on
        ...
        .. note:: Specifying an interval of ``0`` will prevent the function from
                  ...
                  as often as possible, see :py:meth:`~kiglent.clock.Clock.schedule`.
        """
        last_ts = self._get_nearest_ts()
        next_ts = last_ts + interval
    ...
    def schedule_interval_for_duration(self, func: Callable, interval: float,
        ...
        seconds (see  :py:meth:`~kiglent.clock.Clock.schedule_interval`), but
    ...
    def schedule_interval_soft(self, func: Callable, interval: float, *args: Any, **kwargs: Any) -> None:
        ...
        This method is similar to :py:meth:`~kiglent.clock.Clock.schedule_interval`,
        ...
        but not relative to the initial start time.  :py:mod:`kiglent.media`
...
def set_default(default: Clock) -> None:
    ...
    By default, an instance of :py:class:`~kiglent.clock.Clock` is used.
    """
    global _default
    _default = default
...
def get_default() -> Clock:
    """Get the kiglent default Clock.

    Return the :py:class:`~kiglent.clock.Clock` instance that is used by all
...
def schedule_interval_for_duration(func: Callable, interval: float, duration: float, *args, **kwargs) -> None:
    """:see: :py:meth:`~kiglent.clock.Clock.schedule_interval_for_duration`."""
