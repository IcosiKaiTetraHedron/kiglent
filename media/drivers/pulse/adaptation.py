...
from kiglent.media.drivers.base import AbstractAudioDriver, AbstractAudioPlayer, MediaEvent
from kiglent.media.drivers.listener import AbstractListener
from kiglent.media.player_worker_thread import PlayerWorkerThread
...
if TYPE_CHECKING:
    from kiglent.media.codecs import AudioData, AudioFormat, Source
...
class PulseAudioPlayer(AbstractAudioPlayer):
    def __init__(self, source: 'Source', player: 'Player', driver: 'PulseAudioDriver') -> None:
        ...
        self._kiglent_source_exhausted = False
    ...
    def _underflow_callback(self, _stream, _userdata) -> None:
        ...
        with self._audio_data_lock:
            if self._kiglent_source_exhausted and self._audio_data_buffer.available == 0:
    ...
    def _maybe_fill_audio_data_buffer(self) -> None:
        ...
        if self._kiglent_source_exhausted:
            return
        ...
        if new_data is None:
            self._kiglent_source_exhausted = True
