...
if _is_kiglent_doc_run:
    ...
    for driver_name in kiglent.options['audio']:
        try:
            if driver_name == 'pulse':
                ...
                if kiglent.compat_platform in ('win32', 'cygwin'):
                    from kiglent.libs.win32.constants import WINDOWS_8_OR_GREATER
...
def get_audio_driver():
    ...
    See :data:`kiglent.options` ``audio``, and the Programming guide,
